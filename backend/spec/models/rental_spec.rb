...
RSpec.describe Rental, type: :model do
    before(:each) do
        @user = User.new(first_name: 'Sarah', last_name: 'Turner', gender: 'Female', age: 27, email: "sarahturner@gmail.com")
        ...
        @rental = Rental.new(date_rent: '12-06-2023', date_return: '20-06-2023', destination: 'Kentucky', car_id: @car.id, user_id: @user.id)
    end
