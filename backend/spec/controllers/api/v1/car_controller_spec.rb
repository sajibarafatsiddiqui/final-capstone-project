...
RSpec.describe Api::V1::CarsController, type: :request do
    describe "Cars Requests" do
        before do
            ...
            @user = User.create(first_name: 'Bob', last_name: 'Sullivan', gender: 'Male', age: 40, email: 'sully@gmail.com')
        ...
        describe 'POST api/v1/cars' do
            it 'Creates a Car' do
                ...
                post '/api/v1/cars', params: { car: { car_model: 'Toyota Q13', car_status: 'New', rent_price: 650.45, car_image: 'https://th.bing.com/th?id=OAID.ff673dccbcefdc0bde761bee3fe980c1&w=180&h=120&c=2&rs=1&qlt=80&o=6&cdv=1&pid=16.1'}}
